...
##--customise OS parameters--
	def custom_rootfs(self, configs, dir):
		...
		Run(["cp", "-v", "data/rootfs/etc/systemd/system/fstab.service",''.join((dir, "/etc/systemd/system/"))])
		Run(["cp", "-v", "data/rootfs/etc/systemd/system/getty.target.wants/getty@tty1.service",''.join((dir, "/lib/systemd/system/getty@service"))])
